function [detA] = determinante_matriz_escolhe_coluna(A)
% DETERMINANTE_MATRIZ_ESCOLHE_COLUNA: Função que calcula o determinante
% da matriz A escolhendo uma coluna qualquer de A.
% Entrada:
%   A: Matriz A de ordem mxm.
% Saída:
%   detA: Determinante da matriz A.
% Exemplo:
%   [detA] = determinante_matriz_escolhe_coluna([1,2,3;4 8 7;5 2 3])
%==========================================================================
...
if m == n
    nL = [1:m];
    Lna = input('Escolha uma coluna qualquer da matriz A:  ','s');
    L = str2num(Lna);
    vL = find(nL == L);
    if isempty(vL)
      fprintf('\n Indice de coluna incorreto \n');
      detA = [];
    else
      fprintf('=============================================\n');
